...
UBPM (User Behavior Profile Model): Numina AI's proprietary advanced system for understanding your behavior patterns, communication styles, emotional responses, and temporal interactions.
...
• Behavioral Patterns (UBPM Data): Our proprietary UBPM analyzes your interaction data to identify patterns related to your communication style (e.g., detailed, brief, inquisitive, task-oriented), emotional responses (e.g., emotional variance, stress response patterns), temporal activity (e.g., peak hours), and decision-making approaches. This data is used to build and refine your personalized UBPM.
...
• Personalization: To adapt the AI's personality, communication style, and responses to your unique behavioral patterns (UBPM), emotional state, and preferences, making interactions more personalized and meaningful.
...
• Right to Erasure ("Right to Be Forgotten"): You have the right to request the deletion of your Personal Data from our systems. Please note that deleting your data will effectively reset your UBPM and associated personalized experiences.
